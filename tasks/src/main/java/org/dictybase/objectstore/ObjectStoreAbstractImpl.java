package org.dictybase.objectstore;
...
import org.dictybase.objectstore.query.QueryCreator;
...
public abstract class ObjectStoreAbstractImpl implements ObjectStore
{
     ...
     */
    protected ObjectStoreAbstractImpl(Model model, Properties mergedProps) {
        this.model = model;
        Properties props = PropertiesUtil.getPropertiesStartingWith("os.query", mergedProps);
        props = PropertiesUtil.stripStart("os.query", mergedProps);
