...
public final class DatabaseFactory
{
     ...
     */
    public static synchronized Database getDatabase(String instance)
     ...
     *
     * @param instance the name of the database
     * @param intermineProps the Properties object from the intermine configuration file
     * @return a connection to that database
     * @throws SQLException if there is a problem with the underlying database
     * @throws ClassNotFoundException if the class that the instance uses cannot be found
     */
    public static synchronized Database getDatabase(String instance, Properties intermineProps)
        throws SQLException, ClassNotFoundException {
        Database database;
